...
export default React.memo(function LoginPage({ setToken }) {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_API_URL}/user/oauth/sign-in`,
        {
          token: firebaseToken,
        }
      );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-dark-950 via-secondary-950 to-primary-950 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute bottom-0 right-0 w-80 h-80 bg-accent-600/5 rounded-full blur-3xl animate-float"
